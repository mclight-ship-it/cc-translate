...
**提前预热已实现并通过工程验收：**当前包 **0.1.0/build219**，源码 `252e07f`；
...
已加入系统管理的“登录时启动”及批准/关闭/刷新入口，本包另有独立Mac版本0.1.0/构建219；
...
“诊断 → 翻译耗时”仅在内存保留二十次数字记录，不含原文、译文或账号。
producer执行1075个原生测试（1052通过、23个需设置App路径的可选skip、零失败）并保留原生PNG，
这些可选项在后续包内阶段另行通过（Foundation 21、About 1、词典到绘制 1）；
七个独立进程连续流程、三组固定种子各60步随机交互全部完成，另验证跨页关闭取消与快速结果后续请求归属。
同一个App在15.7.9/14.8.9/26.6.2各通过260进程/851核心/21后置Foundation及独立About1；
...
- 源码：`252e07f4ecf727dd5e41ba3541b38f52821391c6`；版本0.1.0、构建219；
  [run36013481443](https://github.com/mclight-ship-it/cc-translate/actions/runs/36013481443)；
  [完整App下载](https://github.com/mclight-ship-it/cc-translate/actions/runs/36013481443/artifacts/10815676224)；
  [原生截图与流程记录](https://github.com/mclight-ship-it/cc-translate/actions/runs/36013481443/artifacts/10814004390)。
- 内层`CCTranslateMac-P0.zip`：22,613,802 bytes；
  SHA-256 `d1c313874cd31089bd21ec1787b93688c787e7721b5afa49b6079004ad59f3b5`。
...
**本轮优先复测：**退出旧版后解压替换 App；关于页面应显示0.1.0/build219，配置/CLI/账号保持原样。
