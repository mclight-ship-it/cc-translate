...
**翻译提速正在实施：**见[性能清单](MACOS_TODO.md#native-translation-latency)。
...
当前包 **0.1.0/build202**，源码 `7953587`；1037 项原生测试（23 可选 skip、零失败），
...
已加入系统管理的“登录时启动”及批准/关闭/刷新入口，本包另有独立Mac版本0.1.0/构建202；
...
producer执行1037个原生测试（1014通过、23个需设置App路径的可选skip、零失败）并保留253张PNG，
...
- 源码：`7953587e9a334b5bd8191a64f74d01c9d957765f`；版本0.1.0、构建202；
  [run35904916359](https://github.com/mclight-ship-it/cc-translate/actions/runs/35904916359)；
  [完整App下载](https://github.com/mclight-ship-it/cc-translate/actions/runs/35904916359/artifacts/10772217886)；
  [原生截图与流程记录](https://github.com/mclight-ship-it/cc-translate/actions/runs/35904916359/artifacts/10771347712)。
- 内层`CCTranslateMac-P0.zip`：22,575,340 bytes；
  SHA-256 `938e61317a8d7c8fc83d95eb8e5fb7c12ce9489199250592a71552ebdcce3e66`。
...
**本轮优先复测：**退出旧版后解压替换 App；关于页面应显示0.1.0/build202，配置/CLI/账号保持原样。
