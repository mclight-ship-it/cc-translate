...
已加入系统管理的“登录时启动”及批准/关闭/刷新入口，本包另有独立Mac版本0.1.0/构建161；
...
- 源码：`2195dfc60d4dbc3b00535ab597076186e83631e4`；版本0.1.0、构建161；
  ...
  [原生离屏截图](https://github.com/mclight-ship-it/cc-translate/actions/runs/35464063349/artifacts/10589969788)。
- 内层`CCTranslateMac-P0.zip`：20,691,347 bytes；
  SHA-256 `eaf1563c53fa70cca18ec61b714572866b6a1e03a892262a30abf3717b5480c8`。
  artifact保留到2026-09-26T19:44:50Z；过期时只取新的经核验固定run，不使用未知镜像。
...
性能目标（下列固定样本工具尚待自身Mac实测）：分类 P95 ≤2ms；常驻 IPC ≤5ms；词典查询+格式化 ≤10ms；
...
尚无这项新工具的真实Mac性能结果，不以本机便携测试通过代替测量。
...
等待修正源码本身的Mac证据，不从旧样本猜测硬件倍率或宣称CPU已达标。
