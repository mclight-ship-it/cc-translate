...
当前推荐下载8f898aa保留bf89495已验图片链路，并已完成完整App同包三系统验收，见
...
producer执行811个原生测试（788通过、23构包前可选skip、零失败）并保留134张PNG，
同一个App在15.7.9/14.8.9/26.6.2各通过232进程/669核心/21后置Foundation及独立About1；
...
- 源码：`8f898aaa25b75babe1591e922701e493ae0d48c8`；
  [run35341468695](https://github.com/mclight-ship-it/cc-translate/actions/runs/35341468695)；
  [完整App下载](https://github.com/mclight-ship-it/cc-translate/actions/runs/35341468695/artifacts/10546356416)；
  [原生离屏截图](https://github.com/mclight-ship-it/cc-translate/actions/runs/35341468695/artifacts/10545303976)。
- 内层`CCTranslateMac-P0.zip`：19,589,258 bytes；
  SHA-256 `72540b5d5bfe7322cea950af7cd718c55829291c96a790707d93370cf4d1df69`。
  artifact保留到2026-09-25T12:13:23Z；过期时只取新的经核验固定run，不使用未知镜像。
...
- Apple Silicon、macOS14+候选；Intel未支持承诺。用户不需要Xcode/Python/Git/付费开发者账号。
  ...
  结果位置、双击间隔、截图全局热键开关与恢复默认已包含；完整Claude等仍在继续。
