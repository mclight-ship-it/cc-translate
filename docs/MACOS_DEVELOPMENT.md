...
874原生项与同包三系统均通过，当前推荐build152。原断言及失败图片保留。
...
已加入系统管理的“登录时启动”及批准/关闭/刷新入口，本包另有独立Mac版本0.1.0/构建152；
...
producer执行874个原生测试（851通过、23构包前可选skip、零失败）并保留145张PNG，
...
- 源码：`2392c14d3e191a6497a7f3cb8a98c72ff0e137ea`；版本0.1.0、构建152；
  [run35450515330](https://github.com/mclight-ship-it/cc-translate/actions/runs/35450515330)；
  [完整App下载](https://github.com/mclight-ship-it/cc-translate/actions/runs/35450515330/artifacts/10585684873)；
  [原生离屏截图](https://github.com/mclight-ship-it/cc-translate/actions/runs/35450515330/artifacts/10586786097)。
- 内层`CCTranslateMac-P0.zip`：20,669,127 bytes；
  SHA-256 `fb8ff816098dd12411cbd0288f8e0f456501ed4e8b452fde176ce4f08b205f02`。
  artifact保留到2026-09-26T15:25:40Z；过期时只取新的经核验固定run，不使用未知镜像。
