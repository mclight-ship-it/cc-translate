...
**当前推荐包：2195dfc，Mac 0.1.0/build161 / [run35464063349](https://github.com/mclight-ship-it/cc-translate/actions/runs/35464063349)。**
...
[完整审计](MACOS_TODO.md#native-p4-complete-checkpoint)已绑定本源码与实际版本；
...
三系统实际About在该检查点核对0.1.0/build146；当前推荐build161已在本轮重新核对。
...
分开首次与100次预热后样本，并保留P95/最大值和未达标结果。build163的producer测量步骤已通过，
完整三系统及原始统计复核仍在运行；
...
等待修正源码自身Mac结果，不以旧绿色测试或猜测倍率报告CPU数字；
