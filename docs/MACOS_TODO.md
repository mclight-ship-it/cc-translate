...
基线：`148f7a1`；仅独立开发分支。更新日期：2026-09-23。
...
## 当前用户实测反馈：交互修正与单窗口重构（2026-09-23，验证中）
...
本节当前为实现/验证跟踪；新包和逐项工程证据待本轮实际 Mac 运行后填写，
不能复用 build191 的截图或测试数字宣称本轮通过。
...
最新推荐包现为[1f8d9ed：Mac 0.1.0/build191，Pearl 原生界面](#native-pearl-ui)，
