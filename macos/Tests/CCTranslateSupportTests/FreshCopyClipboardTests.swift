...
final class FreshCopyClipboardTests: XCTestCase {
    ...
    @MainActor
    func testFileImageConcealedGeneratedAndRichOnlyCopiesAreNotTextFallbacks() async throws {
        let representations: [[NSPasteboard.PasteboardType]] = [
            [.string, .fileURL], [.string, .init("org.nspasteboard.ConcealedType")],
            [.string, .init("org.nspasteboard.TransientType")],
            [.string, .init("org.nspasteboard.AutoGeneratedType")],
            [.string, .init("com.apple.pasteboard.promised-file-url")], [.png], [.rtf], [.html]
        ]
