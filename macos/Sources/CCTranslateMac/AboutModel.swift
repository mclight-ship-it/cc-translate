...
final class AboutModel: ObservableObject {
    ...
    func message(for error: AboutResourceError, using model: ProbeModel) -> String {
        ...
        case .checksumMismatch: return model.text("This file differs from the bundled manifest. No partial or altered text is shown; check the package and retry.", "此文件与随包清单不一致。未显示不完整或改动后的文本，请检查应用程序包后重试。")
        }
    }
}
