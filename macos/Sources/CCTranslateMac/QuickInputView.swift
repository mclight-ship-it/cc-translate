    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            if draft.selectionUnavailable {
                Text(model.text("Couldn't read the selection. Press Command V to paste.",
            ...
            NativeTranslationEditor(text: $draft.text, textScale: model.nativeTextScale,
                ...
                hint: model.text("Type or paste. Command Return translates.",
                                 "输入或粘贴文字，按 Command Return 翻译。"),
                placeholder: model.text("Type or paste text here...", "在这里输入或粘贴文字..."))
                .accessibilityIdentifier("quick-input-editor")
                .padding(12)
                .pearlCard()
