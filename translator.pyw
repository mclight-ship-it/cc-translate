...
# Adaptive tray icons: a transparent "CC" glyph tinted to stay crisp against
# whichever taskbar theme is active. cc-dark.ico is a light glyph for a DARK
# taskbar; cc-light.ico is a brand-blue glyph for a LIGHT taskbar. Both are
# generated by tools/make_icons.py. cc.ico (the blue tile) remains the fallback.
