...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "settings.label.acrylic_enabled": "毛玻璃效果 (Beta)",
        "settings.label.acrylic_help": "使用 Windows 原生实时毛玻璃，背景色调强度固定为 40%。不截屏、不轮询；移动和缩放由系统实时合成。保存后，新打开的窗口生效。",
        "settings.label.acrylic_unavailable_remote": "远程桌面会禁用系统毛玻璃，因此当前会话无法开启。请在 Windows 11 本地会话中使用。",
        "settings.label.acrylic_unavailable_high_contrast": "高对比度模式下不可用。",
        "settings.label.acrylic_unavailable_transparency": "Windows 的“透明效果”已关闭，请先在系统设置中开启。",
        "settings.label.acrylic_unavailable_composition": "桌面窗口合成当前不可用。",
        "settings.label.acrylic_unavailable_windows": "当前 Windows 版本或系统接口不支持此效果。",
    ...
    "en_US": {
        ...
        "settings.label.acrylic_enabled": "Acrylic effect (Beta)",
        "settings.label.acrylic_help": "Uses native, real-time Windows Acrylic with a fixed 40% background tint. It never takes screenshots or polls; Windows composites movement and resize live. Applies to newly opened windows after saving.",
        "settings.label.acrylic_unavailable_remote": "Windows disables system Acrylic in Remote Desktop sessions. Use a local Windows 11 session to enable it.",
        "settings.label.acrylic_unavailable_high_contrast": "Unavailable while High Contrast is enabled.",
        "settings.label.acrylic_unavailable_transparency": "Windows Transparency effects are off. Enable them in System Settings first.",
        "settings.label.acrylic_unavailable_composition": "Desktop window composition is currently unavailable.",
        "settings.label.acrylic_unavailable_windows": "This Windows version or system interface does not support the effect.",
