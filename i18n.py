...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "quick_input.hint": "无选中文字时双击 Ctrl+C 启动本窗口",
        ...
        "settings.label.clipboard_protection_help": "开启后，翻译时会先保存你当前剪贴板内容，并在翻译完成后自动恢复。关闭后将不恢复原剪贴板。",
    ...
    "en_US": {
        ...
        "settings.label.clipboard_protection_help": "When enabled, the app saves your current clipboard content before translation and restores it after translation finishes. When disabled, the original clipboard is not restored.",
        ...
        "quick_input.hint": "Double Ctrl+C with no selected text opens this window.",
