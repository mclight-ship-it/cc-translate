...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "settings.label.clipboard_protection_help": "禁用时，不会在翻译后恢复剪贴板内容。可避免与 Win+Shift+S 截图功能产生冲突。",
    ...
    "en_US": {
        ...
        "settings.label.clipboard_protection_help": "When disabled, clipboard content is not restored after translation. This can prevent conflicts with Win+Shift+S screenshot capture.",
