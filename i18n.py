...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "result.query_ai": "重新用 AI 查询",
        "result.instant_dictionary": "极速词典结果",
        "result.ai_supplement": "AI 补充",
        "result.ai_supplement_loading": "正在补充更多释义…",
        "result.ai_supplement_failed": "AI 补充暂不可用。",
        "result.sources_and_licenses": "来源与许可  ›",
        "result.sources_title": "词典来源",
        "result.show_more_senses": "展开其余 {count} 条  ›",
        ...
        "settings.update_retry": "更新失败 · 重试",
        "settings.update_restarting": "正在重启…",
        ...
        "settings.label.local_dictionary": "离线词典加速",
        "settings.label.local_dictionary_help": "下载后，短词会先查询本机只读词典；仅高置信精确命中会直接显示，其他情况仍使用所选 AI 模型。应用启动时不会自动下载。",
        "settings.dictionary.not_installed": "未安装 · 下载约 {size} MB",
        "settings.dictionary.invalid": "本地数据不可用 · 可重新下载修复",
        "settings.dictionary.installed": "已安装 · {size} MB · {version}",
        "settings.dictionary.downloading": "正在下载… {percent}%",
        "settings.dictionary.downloading_inline": "下载中 {percent}%",
        "settings.dictionary.download": "下载并启用",
        "settings.dictionary.repair": "重新下载",
        "settings.dictionary.manage": "管理词典",
        "settings.dictionary.manage_title": "管理离线词典",
        "settings.dictionary.cancel": "取消下载",
        "settings.dictionary.delete": "删除本地数据",
        "settings.dictionary.delete_title": "删除本地词典",
        "settings.dictionary.delete_confirm": "确定删除已下载的本地词典数据吗？删除后短词查询将继续使用 AI。",
        "settings.dictionary.cancelled": "下载已取消",
        "settings.dictionary.download_failed": "下载失败：{error}",
        "settings.dictionary.delete_failed": "删除失败：{error}",
        ...
        "settings.label.clipboard_protection": "保护剪贴板",
        "settings.label.plain_text_paste": "粘贴为纯文本",
        "settings.label.labs_section": "实验室 (Beta)",
        ...
        "settings.label.history_section": "历史记录",
        "settings.label.history_enabled": "保存历史",
        "settings.label.open_history": "打开历史记录",
        "settings.label.auto_start_boot": "开机自动启动",
        "settings.label.update_section": "更新",
        "settings.label.current_version": "当前版本",
        "settings.label.available_version": "可用版本",
        ...
        "about.data_licenses": "数据许可",
        "about.third_party_notices": "第三方词典数据与许可证",
        ...
        "settings.label.summary_enabled": "长文摘要",
        ...
        "diagnostics.dictionary.enabled": "本地词典加速",
        "diagnostics.dictionary.status": "本地词典状态",
        "diagnostics.dictionary.path": "本地词典路径",
        "diagnostics.dictionary.ready": "可用 · {version} · {entries} 条",
        "diagnostics.dictionary.unavailable": "不可用 · {error}",
        "diagnostics.dictionary.not_initialized": "尚未初始化",
        "diagnostics.dictionary.metrics": "本次运行词典查询",
        "diagnostics.dictionary.metrics_value": "{attempts} 次 · 命中率 {hit_rate:.1f}% · P50 {p50:.2f} ms · P95 {p95:.2f} ms",
        "diagnostics.dictionary.metrics_empty": "尚无查询",
        "diagnostics.dictionary.fallbacks": "AI 回退原因",
        "diagnostics.dictionary.fallbacks_value": "未命中 {miss} · 弱命中 {weak} · 异常 {error} · 已关闭 {disabled}",
        ...
        "diagnostics.codex_login.unverified": "后端尚未验证（认证方式：{method}）；诊断不会发送模型请求",
        "diagnostics.summary.backend_unverified": "后端待验证",
        "diagnostics.action.check_codex_backend": "检查当前 Codex 配置及所选后端的认证，然后尝试翻译。自定义后端不一定使用 codex login。",
    ...
    "en_US": {
        ...
        "result.query_ai": "Query again with AI",
        "result.instant_dictionary": "Instant dictionary result",
        "result.ai_supplement": "AI supplement",
        "result.ai_supplement_loading": "Adding more detail…",
        "result.ai_supplement_failed": "AI supplement is temporarily unavailable.",
        "result.sources_and_licenses": "Sources & licenses  ›",
        "result.sources_title": "Dictionary sources",
        "result.show_more_senses": "Show {count} more  ›",
        ...
        "settings.update_retry": "Update failed · Retry",
        "settings.update_restarting": "Restarting…",
        ...
        "settings.label.local_dictionary": "Offline dictionary acceleration",
        "settings.label.local_dictionary_help": "After download, short terms are checked against a local read-only dictionary first. Only high-confidence exact matches are shown directly; all other queries still use the selected AI model. Nothing is downloaded at startup.",
        "settings.dictionary.not_installed": "Not installed · about {size} MB",
        "settings.dictionary.invalid": "Local data unavailable · download again to repair",
        "settings.dictionary.installed": "Installed · {size} MB · {version}",
        "settings.dictionary.downloading": "Downloading… {percent}%",
        "settings.dictionary.downloading_inline": "Downloading {percent}%",
        "settings.dictionary.download": "Download and enable",
        "settings.dictionary.repair": "Download again",
        "settings.dictionary.manage": "Manage dictionary",
        "settings.dictionary.manage_title": "Manage offline dictionary",
        "settings.dictionary.cancel": "Cancel download",
        "settings.dictionary.delete": "Delete local data",
        "settings.dictionary.delete_title": "Delete local dictionary",
        "settings.dictionary.delete_confirm": "Delete the downloaded local dictionary data? Short-term queries will continue to use AI.",
        "settings.dictionary.cancelled": "Download cancelled",
        "settings.dictionary.download_failed": "Download failed: {error}",
        "settings.dictionary.delete_failed": "Delete failed: {error}",
        ...
        "settings.label.clipboard_protection": "Clipboard Protection",
        "settings.label.plain_text_paste": "Paste as plain text",
        "settings.label.labs_section": "Labs (Beta)",
        ...
        "settings.label.history_section": "History",
        "settings.label.history_enabled": "Save history",
        "settings.label.open_history": "Open history",
        ...
        "settings.label.available_version": "Available version",
        ...
        "settings.label.summary_enabled": "Long-text Summary",
        ...
        "about.data_licenses": "Data licenses",
        "about.third_party_notices": "Third-party dictionary data and licenses",
        ...
        "diagnostics.dictionary.enabled": "Local dictionary acceleration",
        "diagnostics.dictionary.status": "Local dictionary status",
        "diagnostics.dictionary.path": "Local dictionary path",
        "diagnostics.dictionary.ready": "Ready · {version} · {entries} entries",
        "diagnostics.dictionary.unavailable": "Unavailable · {error}",
        "diagnostics.dictionary.not_initialized": "Not initialized",
        "diagnostics.dictionary.metrics": "Dictionary queries this session",
        "diagnostics.dictionary.metrics_value": "{attempts} · hit rate {hit_rate:.1f}% · P50 {p50:.2f} ms · P95 {p95:.2f} ms",
        "diagnostics.dictionary.metrics_empty": "No queries yet",
        "diagnostics.dictionary.fallbacks": "AI fallback reasons",
        "diagnostics.dictionary.fallbacks_value": "miss {miss} · weak {weak} · error {error} · disabled {disabled}",
        ...
        "diagnostics.codex_login.unverified": "Backend unverified (auth: {method}); diagnostics do not send a model request",
        "diagnostics.summary.backend_unverified": "Backend unverified",
        "diagnostics.action.check_codex_backend": "Check the current Codex config and selected backend credentials, then try a translation. Custom backends do not necessarily use codex login.",
