...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "settings.label.codex_streaming": "Codex 长文流式 (Beta)",
        "settings.label.codex_streaming_help": "仅对 Codex 的长文本启用 app-server 增量显示。该功能处于 Beta；启动前失败会自动使用稳定的非流式模式。",
        ...
        "diagnostics.codex_streaming": "Codex 长文流式 (Beta)",
    ...
    "en_US": {
        ...
        "settings.label.codex_streaming": "Codex long-text streaming (Beta)",
        "settings.label.codex_streaming_help": "Uses Codex app-server to reveal long translations incrementally. The feature is in Beta; failures before output automatically use the stable non-streaming path.",
        ...
        "diagnostics.codex_streaming": "Codex long-text streaming (Beta)",
