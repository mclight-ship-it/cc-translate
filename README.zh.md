...
<p align="center">
  <img src="docs/screenshots/popup-translate.png" alt="选中文字并显示 CC Translate 弹窗" width="760"><br>
  <sub><b>选中文字，再双击 Ctrl+C</b> —— 译文直接出现在选区旁</sub>
</p>
...
受管理模型目录和 app-server 路径允许 Codex **0.146.0 及以上稳定版本**进入运行时验证，
不再精确锁定一个版本。新版仍须通过目录往返和协议检查，版本较新不等于已证明兼容；
无法识别的版本和预发布版本不自动放行。
