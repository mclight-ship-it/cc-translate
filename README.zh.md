...
<p align="center">
  <img src="docs/screenshots/popup-dict.png" alt="本地词典即时结果与 AI 补充" width="520"><br>
  <sub><b>本地词典即时结果 + AI 补充</b> —— 有来源的释义先显示，AI 在后台补齐缺失信息，不阻塞首屏</sub>
</p>

<table>
<tr>
<td width="50%" valign="top" align="center">
  <img src="docs/screenshots/popup-translate.png" alt="划词翻译弹窗" width="360"><br>
